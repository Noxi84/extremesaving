...
public class YearlyBarChartService implements ChartService {
    ...
    public void generateChartPng() {
        ...
        chartDataService.writeChartPng(barChart, PropertiesValueHolder.getString(YEARLY_BAR_CHART_IMAGE_FILE), (int) YearBarChartPdfSectionCreatorImpl.CHART_WIDTH * 2, (int) YearBarChartPdfSectionCreatorImpl.CHART_HEIGHT * 2);
    }
